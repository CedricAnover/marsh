...
class RemoteCommandExecutor(Executor):
    """Abstract class for executing commands on remote systems."""
    # TODO: Implement Abstract Class and Interface for RemoteExecutor
    # (e.g. SSH, HTTP/S, gRPC, etc.)
    # We may build this on top of Plumbum, Fabric, Paramiko, and/or Ansible.
    def run(self, x_stdout, x_stderr, *args, **kwargs):
