...
from marsh.command_runner_decorators import print_all_output_streams
...
cmdpipe_pass_1 = Conveyor().add_cmd_runner(print_all_output_streams(bash_factory.create_cmd_runner("echo 1")))
cmdpipe_pass_2 = Conveyor().add_cmd_runner(print_all_output_streams(bash_factory.create_cmd_runner("echo 2")))
cmdpipe_fail_1 = Conveyor().add_cmd_runner(print_all_output_streams(bash_factory.create_cmd_runner("cho 1")))
cmdpipe_fail_2 = Conveyor().add_cmd_runner(print_all_output_streams(bash_factory.create_cmd_runner("cho 1")))
...
# pass_and_pass()  #<-- Print 1 and 2
# pass_and_fail()  #<-- Print 1 and Raise error
